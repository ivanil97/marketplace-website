...
def get_popular_items():
    ...
    """
    popular_items_raw = Product.objects.filter(archived=False).order_by('?').prefetch_related('seller_price').prefetch_related('images') #TODO: добавить условия сортировки в соответствии с ТЗ
